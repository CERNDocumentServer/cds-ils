...
def test_migrate_record(datadir, base_app):
    ...
    with base_app.app_context():
        ...
        assert res == {
            '_migration': {
                ...
                'volumes': [
                    ...
                    {'title': 'Popularization and people (1911-1962)',
                     'volume': '12'}], 'volumes_identifiers': [
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '0444855012'}],
                        'physical_description': 'print version',
                        'volume': '5'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '0444867120'}],
                        'physical_description': 'print version',
                        'volume': '6'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '0444869298'}],
                        'physical_description': 'print version',
                        'volume': '9'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '0444899723'}],
                        'physical_description': 'print version',
                        'volume': '10'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '0720418003'}],
                        'physical_description': 'print version',
                        'volume': '7'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780080870991'}],
                        'physical_description': 'electronic version',
                        'volume': '1'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780080871004'}],
                        'physical_description': 'electronic version',
                        'volume': '2'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780080871011'}],
                        'physical_description': 'electronic version',
                        'volume': '3'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780080871028'}],
                        'physical_description': 'electronic version',
                        'volume': '4'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780080871035'}],
                        'physical_description': 'electronic version',
                        'volume': '5'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780080871059'}],
                        'physical_description': 'electronic version',
                        'volume': '7'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780080871066'}],
                        'physical_description': 'electronic version',
                        'volume': '8'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780080871073'}],
                        'physical_description': 'electronic version',
                        'volume': '9'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780444513366'}],
                        'physical_description': 'print version',
                        'volume': '11'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780444529466'}],
                        'physical_description': 'print version',
                        'volume': '12'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780444865014'}],
                        'physical_description': 'print version',
                        'volume': '5'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780444867124'}],
                        'physical_description': 'print version',
                        'volume': '6'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780444869296'}],
                        'physical_description': 'print version',
                        'volume': '9'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780444870032'}],
                        'physical_description': 'print version',
                        'volume': '8'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780444898920'}],
                        'physical_description': 'print version',
                        'volume': '7'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780444899729'}],
                        'physical_description': 'print version',
                        'volume': '10'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780720418002'}],
                        'physical_description': 'print version',
                        'volume': '7'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780720418019'}],
                        'physical_description': 'print version',
                        'volume': '1'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780720418026'}],
                        'physical_description': 'print version',
                        'volume': '2'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780720418033'}],
                        'physical_description': 'print version',
                        'volume': '3'},
                    {'identifiers': [
                        {'scheme': 'ISBN', 'value': '9780720418040'}],
                        'physical_description': 'print version',
                        'volume': '4'}],
                'volumes_urls': [
                    {'_migration': {
            ...
            'provider_recid': '104450', 'legacy_recid': 104450,
            'agency_code': 'SzGeCERN', 'languages': ['ENG'],
            'subjects': [{'value': '53(08)', 'scheme': 'UDC'},
                         {'value': '53', 'scheme': 'UDC'},
                         {'value': '92', 'scheme': 'UDC'},
            ...
            'authors': [{'full_name': 'Bohr, Niels Henrik David',
                         'roles': ['AUTHOR'], "type": "PERSON"},
            ...
            'source': 'ELS', '_created': '1985-01-07', 'keywords': [
                {'value': 'correspondence', 'source': 'CERN'}],
            'document_type': 'BOOK',
