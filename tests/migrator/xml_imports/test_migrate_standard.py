...
def test_migrate_record(datadir, base_app):
    ...
    with base_app.app_context():
        ...
        assert res == {
            ...
            'imprint': {'date': '2008-01-01',
                        'place': 'West Conshohocken, PA',
                        'publisher': 'ASTM'},
            'document_type': 'STANDARD', 'number_of_pages': '11',
            ...
            'authors': [{
                ...
                'type': 'ORGANISATION'}],
            'internal_notes': [{'value': 'ASTM201207 - vol.03.01'},
                               {'value': 'BOTyhdiO1HVI.pdf'}],
            'created_by': {'type': 'user'},
            '_created': '2012-07-23', 'languages': ['ENG'],
            'subjects': [{'value': '77.040.10', 'scheme': 'ICS'}],
            '_migration': {'record_type': 'document', 'volumes': [],
                           'volumes_identifiers': [],
