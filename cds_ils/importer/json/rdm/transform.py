...
from ...providers.ebl.rules.document import abstract
...
class ILSEntry:
    ...
    def _alternative_abstracts(self):
        additional_desc = self.rdm_metadata["additional_descriptions"]
        abstracts = []
    ...
    def _alternative_identifiers(self):
        ...
        for _id in self.rdm_metadata["identifiers"]:
    ...
    def _authors(self):
        ...
        for entry in self.rdm_metadata["creators"]:
            author = {
                ...
                "identifiers": identifiers(entry["person_or_org"]["identifiers"]),
            }
            if "role" in entry:
    ...
    def _conference_info(self):
        ...
        _ils_conference = {
            ...
            "datas": rdm_conference.get("dates"),
    ...
    def metadata(self):
        record = {
            ...
            "_eitem": self._eitem(),
            "_rdm_pid": self.rdm_entry["id"],
            "agency_code": "SzGeCERN",
            "abstract": self.rdm_metadata["description"],
