...
from cds_books.ldap.models import LdapSynchronizationLog
from cds_books.ldap.tasks import synchronize_users_task
...
class LdapSynchronizationLogModelView(ModelView):
    ...
    def create_view(self):
        ...
        return self.render('cds_books_admin/create_task.html',
